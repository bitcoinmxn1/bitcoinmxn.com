...
### Si Bitcoin Cash tiene una potencia hash relativamente baja, podemos esperar algunos ajustes de dificultad en este momento. La mayoría de los escenarios dan como resultado algo cercano a los tiempos de bloque de 10 minutos, siempre que la potencia de hash permanezca constante.

### Esta probablemente no es una suposición segura ya que los mineros probablemente cambiarán entre Bitcoin y Bitcoin Cash dependiendo de cuál sea más rentable.

### Bitcoin Cash será mucho más fácil de extraer después de los ajustes de dificultad, y podemos obtener algunos bloques relativamente rápidos (2.5 minutos o menos) hasta que lleguemos al bloque 479.808.

# 8 al 14 de agosto

### SegWit debería estar conectado a Bitcoin por esta vez.

### Dependiendo de cuánto se transfiera la potencia minera a Bitcoin Cash, y de cuánta nueva potencia minera se presente, el bloqueo en el bloque 479,808 en bitcoin puede llevar más tiempo de lo esperado.

### Una vez que se logra el bloqueo, el código se activará más adelante este mes, actualizando de manera efectiva la cadena de bloques bitcoin principal para admitir transacciones de mayor capacidad.
